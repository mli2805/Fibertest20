...
rem On Teamcity OtdrMeasEngine folder will be created from Iit_Otdr_Vs build (Fibertest Itself dependecies) 
...
rem Create self-extracted installers
...
xcopy ..\Client\DirectRtuClient\bin\Release\*.* PackAdmin\DirectRtuClient\bin\*.* /S/D/Y
