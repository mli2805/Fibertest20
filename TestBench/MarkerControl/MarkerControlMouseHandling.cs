...
namespace Iit.Fibertest.TestBench
{
    ...
    public partial class MarkerControl
    {
        ...
        void MarkerControl_PreviewMouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                Mouse.Capture(null);
                _owner.GraphVm.Ask = new MoveNode() { Id = _marker.Id, Latitude = _marker.Position.Lat, Longitude = _marker.Position.Lng };
            }
        ...
        private void EndTraceDefinition()
        {
            ...
            _owner.GraphVm.Ask = new AskAddTrace() {NodeWithRtuId = _mainMap.StartNode.Id, LastNodeId = _marker.Id};
        }
        ...
        private void EndFiberCreation()
        {
            ...
            if (!_mainMap.IsFiberWithNodes)
                _owner.GraphVm.Ask = new AddFiber() { Node1 = _mainMap.StartNode.Id, Node2 = _marker.Id };
            else
                _owner.GraphVm.Ask = new AskAddFiberWithNodes() { Node1 = _mainMap.StartNode.Id, Node2 = _marker.Id, };
