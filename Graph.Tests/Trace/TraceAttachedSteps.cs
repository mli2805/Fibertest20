...
namespace Graph.Tests
{
    ...
    public sealed class TraceAttachedSteps
    {
        ...
        {
            _traceLeaf.MyContextMenu.FirstOrDefault(item => item?.Header == Resources.SID_Unplug_trace).Should().NotBeNull();
        ...
        public void ThenТрассаПрисоединяетсяКПортуРту()
        {
            ...
            var rtuLeaf = (RtuLeaf)_sut.TreeOfRtuViewModel.TreeOfRtuModel.GetById(_rtuId);
