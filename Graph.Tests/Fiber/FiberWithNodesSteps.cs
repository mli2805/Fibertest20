...
namespace Graph.Tests
{
    ...
    public sealed class FiberWithNodesSteps
    {
        ...
        {
            _sut.ShellVm.ProcessAsk(new AddNode());
            _sut.ShellVm.ProcessAsk(new AddNode());
        ...
        {
            _sut.ShellVm.ProcessAsk(new AddFiber() {Node1 = _leftNodeId, Node2 = _rightNodeId});
            _fibersCountCutOff = _sut.ShellVm.ReadModel.Fibers.Count;
        }
        ...
        {
            _sut.ShellVm.ProcessAsk(new AskAddFiberWithNodes() {Node1 = _leftNodeId, Node2 = _rightNodeId});
        }
