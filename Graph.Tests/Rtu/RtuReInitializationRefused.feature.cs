...
#line hidden
        ...
        public RtuReInitializationRefusedFeature()
        {
            this.TestInitialize();
        }
...
#line hidden
        ...
        public virtual void SetFixture(RtuReInitializationRefusedFeature.FixtureData fixtureData)
        {
        }
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Отказ в переинициализации RTU из-за слишком старой подмены", ((string[])(null)));
#line 7
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Отказ в переинициализации RTU из-за номера порта для БОПа", ((string[])(null)));
#line 13
this.ScenarioSetup(scenarioInfo);
#line 3
this.FeatureBackground();
