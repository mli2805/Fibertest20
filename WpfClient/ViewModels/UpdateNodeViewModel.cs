...
namespace Iit.Fibertest.WpfClient.ViewModels
{
    public class UpdateNodeViewModel : Screen, IDataErrorInfo
    {
        ...
        public void LaunchAddEquipmentView()
        {
            ...
            var addEquipmentViewModel = new EquipmentViewModel(NodeId, Guid.Empty, new List<Guid>(),  _readModel, _aggregate);
        ...
        public void LaunchUpdateEquipmentView()
        {
            ...
            var windowManager = IoC.Get<IWindowManager>();
            var equipmentViewModel = new EquipmentViewModel(NodeId, eq.Id, null, _readModel, _aggregate);
