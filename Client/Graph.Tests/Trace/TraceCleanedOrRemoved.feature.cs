...
namespace Graph.Tests.Trace
{
    ...
    [NUnit.Framework.DescriptionAttribute("TraceCleanedOrRemoved")]
    public partial class TraceCleanedOrRemovedFeature
    {
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Очистка трассы частично совпадающей с другой")]
        public virtual void ОчисткаТрассыЧастичноСовпадающейСДругой()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Очистка трассы частично совпадающей с другой", null, ((string[])(null)));
#line 8
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Удаление трассы частично совпадающей с другой")]
        public virtual void УдалениеТрассыЧастичноСовпадающейСДругой()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Удаление трассы частично совпадающей с другой", null, ((string[])(null)));
#line 13
this.ScenarioInitialize(scenarioInfo);
            this.ScenarioStart();
#line 3
