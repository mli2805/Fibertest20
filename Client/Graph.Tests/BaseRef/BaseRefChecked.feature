...
Scenario: Проверка применимости базовых
	When Пользователь указывает путь к базовым c длинной волны SM1625 и жмет сохранить
	Then Отказ с указанием неправильной длины волны SM1625 И базовые не заданы
