...
#line hidden
        ...
        public UserHidesTracesFeature(UserHidesTracesFeature.FixtureData fixtureData, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Пользователь скрывает и показывает трассы", null, ((string[])(null)));
#line 3
