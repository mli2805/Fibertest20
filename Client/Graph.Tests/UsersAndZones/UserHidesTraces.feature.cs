...
namespace Graph.Tests.UsersAndZones
{
    ...
    [NUnit.Framework.DescriptionAttribute("UserHidesTraces")]
    public partial class UserHidesTracesFeature
    {
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Пользователь скрывает и показывает трассы")]
