...
namespace Graph.Tests.UsersAndZones
{
    ...
    [NUnit.Framework.DescriptionAttribute("UsersPrivileges")]
    public partial class UsersPrivilegesFeature
    {
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Проверка операций доступных различным пользователям")]
