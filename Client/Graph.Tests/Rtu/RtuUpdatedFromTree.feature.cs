...
namespace Graph.Tests.Rtu
{
    ...
    [NUnit.Framework.DescriptionAttribute("RtuUpdatedFromTree")]
    public partial class RtuUpdatedFromTreeFeature
    {
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Клик в дереве открывает окно позволяет редактировать и сохранять изменения RTU")]
        public virtual void КликВДеревеОткрываетОкноПозволяетРедактироватьИСохранятьИзмененияRTU()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Клик в дереве открывает окно позволяет редактировать и сохранять изменения RTU", null, ((string[])(null)));
#line 3
