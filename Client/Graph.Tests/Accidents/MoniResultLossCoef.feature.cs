...
namespace Graph.Tests.Accidents
{
    ...
    [NUnit.Framework.DescriptionAttribute("MoniResultLossCoef")]
    public partial class MoniResultLossCoefFeature
    {
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Легкое превышение коэффициента затухания на фоне более серьезной аварии")]
        public virtual void ЛегкоеПревышениеКоэффициентаЗатуханияНаФонеБолееСерьезнойАварии()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Легкое превышение коэффициента затухания на фоне более серьезной аварии", null, ((string[])(null)));
#line 3
