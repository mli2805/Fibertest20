...
namespace Graph.Tests.Equipment
{
    ...
    [NUnit.Framework.DescriptionAttribute("EquipmentAtGpsLocationAdded")]
    public partial class EquipmentAtGpsLocationAddedFeature
    {
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Добавление узла с оборудованием")]
        public virtual void ДобавлениеУзлаСОборудованием()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Добавление узла с оборудованием", null, ((string[])(null)));
#line 3
