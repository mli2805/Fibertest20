...
namespace Graph.Tests
{
    public static class SceneForLandmarksForm
    {
        ...
        {
            sut.GraphReadModel.GrmEquipmentRequests
                .AddEquipmentAtGpsLocation(new RequestAddEquipmentAtGpsLocation()
            ...
            sut.FakeWindowManager.RegisterHandler(model => 
                sut.FiberWithNodesAdditionHandler(model, 1, EquipmentType.AdjustmentPoint, Answer.Yes));
            sut.GraphReadModel.GrmFiberWithNodesRequest
                .AddFiberWithNodes(new RequestAddFiberWithNodes() { Node1 = nodeIdB, Node2 = nodeIdA }).Wait();
            sut.Poller.EventSourcingTick().Wait();
            ...
            sut.FakeWindowManager.RegisterHandler(model => 
                sut.FiberWithNodesAdditionHandler(model, 1, EquipmentType.EmptyNode, Answer.Yes));
            sut.GraphReadModel.GrmFiberWithNodesRequest
                .AddFiberWithNodes(new RequestAddFiberWithNodes()
